...
######################################################################################
#
# Description: runs input process sensitivity test (input process is called lift here)
#
######################################################################################
######################################################################################
...
# tested input processes
signature_lifts = ["baseline", "volatility", "qv_volatility", "payoff"]
...
for signature_lift, strike in product(
    signature_lifts,
    strikes
):        
    ...
    results.append(
        {
            ...
            "Signature Lift Primal": signature_lift,
            "Signature Lift Dual": signature_lift,
