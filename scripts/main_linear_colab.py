...
######################################################################################
#
# Description: price using readout-only neural networks (linear model)
#
######################################################################################
######################################################################################
...
primal_layers=0 #
primal_epochs=2000 #
primal_batch_size=2**10 #
primal_activation='linear' #
primal_polynomials=5

dual_layers=0 #
dual_epochs=2000 #?
dual_batch_size=2**10 #
dual_activation='linear' #
dual_polynomials=5
