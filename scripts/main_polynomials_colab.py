...
######################################################################################
#
# Description: runs polynomial sensitivity test
#
######################################################################################
######################################################################################
...
# override vars here
primal_polynomials=None
dual_polynomials=None
...
def run_test(paths, K_trunc, signature_spec, signature_lift_primal, signature_lift_dual, strike, polynomials):
    ...
    pricer.train(primal_layers, primal_nodes, primal_epochs, primal_batch_size, primal_learning_rate, primal_activation, primal_dropout, polynomials, primal_state_spec, primal_regularizer, primal_regularizer_alpha,
                dual_layers, dual_nodes, dual_epochs, dual_batch_size, dual_learning_rate, dual_activation, dual_dropout, polynomials, dual_state_spec, dual_regularizer, dual_regularizer_alpha)
...
for poly in polynomials:
    print(f"Pricing with polynomials={poly}")
