...
######################################################################################
#
# Description: runs state average/payoff/none sensitivity test
#
######################################################################################
######################################################################################
...
# override vars here
primal_state_spec=None
dual_state_spec=None
...
def run_test(paths, K_trunc, signature_spec, signature_lift_primal, signature_lift_dual, strike, additions):
    ...
    pricer.train(primal_layers, primal_nodes, primal_epochs, primal_batch_size, primal_learning_rate, primal_activation, primal_dropout, primal_polynomials, additions, primal_regularizer, primal_regularizer_alpha,
                dual_layers, dual_nodes, dual_epochs, dual_batch_size, dual_learning_rate, dual_activation, dual_dropout, dual_polynomials, additions, dual_regularizer, dual_regularizer_alpha)
...
# tested parameters
additions_params = [[],["average"],["payoff"]]
...
for strike, additions in product(
    strikes,
    additions_params
):
